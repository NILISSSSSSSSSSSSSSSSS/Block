<template>
  <div>
    ...
    <!-- blocks列表-->
    <div class="routerShow_width" v-if="tabAll.tableData.length!==0">
      <div class="pageBox" >
...
//           }
    ...
    mounted:function(){
      this.$http.get(this.config.bathUrl+"/blocks")
        .then(res => {
          this.tabAll.tableData=res.data.data
         console.log(this.tabAll.tableData)
      })
      .catch(function (err) {
        console.log(err);
      });
